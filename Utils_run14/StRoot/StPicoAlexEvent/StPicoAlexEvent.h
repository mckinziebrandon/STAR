...
private:
    ...
    Int_t    mNHitsMapHFT;      // HFT map table
...
public:
    StPicoAlexTrack() :
        ...
        mDedx(0),mNHitsFit(0),mNHitsMax(0),mNHitsDedx(0),mNSigmaPion(0),mNSigmaKaon(0),mNSigmaProton(0),mNSigmaElectron(0),mNHitsMapHFT(0),mBTofCellId(0),
        ...
        mBTOWE3(0),mBTOWDistEta(0),mBTOWDistPhi(0)
    {
        ...
        Int_t          nHitsMapHFT() const    { return (Float_t)mNHitsMapHFT; }
        ...
        void setnHitsMapHFT(Int_t i)      { mNHitsMapHFT = i; }
