...
static const Int_t n_cuts = 10; // 10
static TH1F* hInvMass_pt[2][npt_bins]; // [SE,ME][pt bin]
static TH1F* hInvMass_pt_cuts[2][npt_bins][n_cuts]; // [SE,ME][pt bin]
//static TH1F* hInvMass_pt_cuts_var[2][npt_bins][n_cuts_var*n_cuts_var*n_cuts_var*n_cuts_var*n_cuts_var]; // [SE,ME][p_t][m][t][up ns][low ns]
...
static TH1F* hInvMass_mult_pt_phi_ep_seme[nmult_bins][npt_bins][nphi_bins][nep_methods][2];
