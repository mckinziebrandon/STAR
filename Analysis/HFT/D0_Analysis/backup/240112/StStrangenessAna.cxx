...
const char V0_TREE[N_Analysis] = {"AlexPhiMesonEvents","XiM_v2_tree","XiP_v2_tree","OmegaM_v2_tree","OmegaP_v2_tree","Lambda_X_NT","Lambda_X_NT"};
const char V0_BRANCH[N_Analysis] = {"Events","XiM_v2_branch","XiP_v2_branch","OmegaM_v2_branch","OmegaP_v2_branch","Lambda_X_NT","Lambda_X_NT"};

static const char ALEXV0_EVENT_TREE[]         = V0_TREE[eAnalysis];
static const char ALEXV0_EVENT_BRANCH[]       = V0_BRANCH[eAnalysis];
...
void StStrangenessAna::init()
{
    ...
    {
        cout << "Open same event file list " << MEList << endl;
    ...
    Int_t   nAna_InvMass_bins[N_Analysis]  = {200,200,200,200,200,200,200};
    Float_t nAna_InvMass_start[N_Analysis] = {0.98,0.98,0.98,0.98,0.98,0.98,0.98};
    Float_t nAna_InvMass_stop[N_Analysis]  = {1.16,1.16,1.16,1.16,1.16,1.16,1.16};
    ...
    for(Int_t SE_ME_loop = 0; SE_ME_loop < 2; SE_ME_loop++) // 0 = same event, 1 = mixed event
    {
        for(Int_t pt_bin = 0; pt_bin < npt_bins; pt_bin++)
        {
            for(Int_t n_p_t = 0; n_p_t < n_cuts_var; n_p_t++)
            {
                for(Int_t n_m = 0; n_m < n_cuts_var; n_m++)
                {
                    for(Int_t n_t = 0; n_t < n_cuts_var; n_t++)
                    {
                        for(Int_t n_up_ns = 0; n_up_ns < n_cuts_var; n_up_ns++)
                        {
                            for(Int_t n_low_ns = 0; n_low_ns < n_cuts_var; n_low_ns++)
                            {
                                HistName = "hInvMass_pt_cuts_var_";
                                HistName += SE_ME_loop;
                                HistName += "_pt";
                                HistName += pt_bin;
                                HistName += "_p";
                                ...
                                HistName += "_low";
                                HistName += n_low_ns;
                                Int_t bin_pt_cuts_var = n_low_ns + n_up_ns*n_cuts_var + n_t*n_cuts_var*n_cuts_var + n_m*n_cuts_var*n_cuts_var*n_cuts_var + n_p_t*n_cuts_var*n_cuts_var*n_cuts_var*n_cuts_var;
                                hInvMass_pt_cuts_var[SE_ME_loop][pt_bin][bin_pt_cuts_var] = new TH1F(HistName.Data(),HistName.Data(),nAna_InvMass_bins[eAnalysis],nAna_InvMass_start[eAnalysis],nAna_InvMass_stop[eAnalysis]);
                                hInvMass_pt_cuts_var[SE_ME_loop][pt_bin][bin_pt_cuts_var] ->Sumw2();
                            }
                        }
                    }
                }
...
void StStrangenessAna::loop()
{
    ...
    // 11.5 GeV
    Int_t params_best_cuts[npt_bins][5];
    // [pt bin][n_p_t, n_m, n_t, n_up_ns, n_low_ns]
    params_best_cuts[0][0]  = 0; params_best_cuts[0][1]  = 4; params_best_cuts[0][2]  = 0; params_best_cuts[0][3]  = 3; params_best_cuts[0][4]  = 0;
    params_best_cuts[1][0]  = 1; params_best_cuts[1][1]  = 4; params_best_cuts[1][2]  = 0; params_best_cuts[1][3]  = 4; params_best_cuts[1][4]  = 1;
    params_best_cuts[2][0]  = 2; params_best_cuts[2][1]  = 2; params_best_cuts[2][2]  = 0; params_best_cuts[2][3]  = 4; params_best_cuts[2][4]  = 2;
    params_best_cuts[3][0]  = 3; params_best_cuts[3][1]  = 4; params_best_cuts[3][2]  = 3; params_best_cuts[3][3]  = 2; params_best_cuts[3][4]  = 4;
    params_best_cuts[4][0]  = 4; params_best_cuts[4][1]  = 1; params_best_cuts[4][2]  = 1; params_best_cuts[4][3]  = 1; params_best_cuts[4][4]  = 4;
    params_best_cuts[5][0]  = 4; params_best_cuts[5][1]  = 3; params_best_cuts[5][2]  = 2; params_best_cuts[5][3]  = 4; params_best_cuts[5][4]  = 4;
    params_best_cuts[6][0]  = 0; params_best_cuts[6][1]  = 4; params_best_cuts[6][2]  = 4; params_best_cuts[6][3]  = 1; params_best_cuts[6][4]  = 4;
    params_best_cuts[7][0]  = 0; params_best_cuts[7][1]  = 2; params_best_cuts[7][2]  = 1; params_best_cuts[7][3]  = 0; params_best_cuts[7][4]  = 4;
    params_best_cuts[8][0]  = 0; params_best_cuts[8][1]  = 4; params_best_cuts[8][2]  = 3; params_best_cuts[8][3]  = 3; params_best_cuts[8][4]  = 0;
    params_best_cuts[9][0]  = 0; params_best_cuts[9][1]  = 2; params_best_cuts[9][2]  = 1; params_best_cuts[9][3]  = 4; params_best_cuts[9][4]  = 4;
    params_best_cuts[10][0] = 0; params_best_cuts[10][1] = 1; params_best_cuts[10][2] = 2; params_best_cuts[10][3] = 4; params_best_cuts[10][4] = 0;
    params_best_cuts[11][0] = 0; params_best_cuts[11][1] = 2; params_best_cuts[11][2] = 4; params_best_cuts[11][3] = 3; params_best_cuts[11][4] = 1;
    params_best_cuts[12][0] = 0; params_best_cuts[12][1] = 0; params_best_cuts[12][2] = 2; params_best_cuts[12][3] = 2; params_best_cuts[12][4] = 2;
    params_best_cuts[13][0] = 0; params_best_cuts[13][1] = 1; params_best_cuts[13][2] = 4; params_best_cuts[13][3] = 0; params_best_cuts[13][4] = 3;
    params_best_cuts[14][0] = 0; params_best_cuts[14][1] = 0; params_best_cuts[14][2] = 4; params_best_cuts[14][3] = 4; params_best_cuts[14][4] = 3;
    params_best_cuts[15][0] = 0; params_best_cuts[15][1] = 1; params_best_cuts[15][2] = 4; params_best_cuts[15][3] = 3; params_best_cuts[15][4] = 0;
    params_best_cuts[16][0] = 0; params_best_cuts[16][1] = 0; params_best_cuts[16][2] = 0; params_best_cuts[16][3] = 0; params_best_cuts[16][4] = 0;
    params_best_cuts[17][0] = 0; params_best_cuts[17][1] = 0; params_best_cuts[17][2] = 0; params_best_cuts[17][3] = 0; params_best_cuts[17][4] = 0;
    params_best_cuts[18][0] = 0; params_best_cuts[18][1] = 0; params_best_cuts[18][2] = 0; params_best_cuts[18][3] = 0; params_best_cuts[18][4] = 0;
    params_best_cuts[19][0] = 0; params_best_cuts[19][1] = 0; params_best_cuts[19][2] = 0; params_best_cuts[19][3] = 0; params_best_cuts[19][4] = 0;
    ...
    for(Int_t SE_ME_loop = 0; SE_ME_loop < 2; SE_ME_loop++) // 0 = same event, 1 = mixed event
    {
        ...
        for(Long64_t counter = start_event_use; counter < stop_event_use; counter++)
        {
              ...
              )
            {
                ...
                Float_t VerdistX2, VerdistY2, scal_prod, scal_prod2;
                ...
                for(UShort_t i = 0; i < erun_nevents; ++i) // loop over all tracks of the actual event
                {
                    ...
                    Double_t start_p_t    = 0.5;
                    Double_t delta_p_t    = 0.2;
                    Double_t start_m      = 8.5;
                    Double_t delta_m      = 0.9;
                    Double_t start_t      = -6.0;
                    Double_t delta_t      = -1.0;
                    Double_t start_up_ns  = 1.7;
                    Double_t delta_up_ns  = 0.2;
                    Double_t start_low_ns = -2.3;
                    Double_t delta_low_ns = 0.3;
                      ...
                      )
                    {
                        ...
                        /*
                         for(Int_t n_p_t = 0; n_p_t < n_cuts_var; n_p_t++)
                         {
                         Double_t p_t_cut      = ((Double_t)n_p_t)*delta_p_t+start_p_t;
                         if(
                         p_t < p_t_cut || (p_t >= p_t_cut && ( (m2A > 0.16 && m2A < 0.36) || (m2B > 0.16 && m2B < 0.36) ) )
                         )
                         {
                         for(Int_t n_up_ns = 0; n_up_ns < n_cuts_var; n_up_ns++)
                         {
                         Double_t up_ns_cut    = ((Double_t)n_up_ns)*delta_up_ns+start_up_ns;
                         for(Int_t n_low_ns = 0; n_low_ns < n_cuts_var; n_low_ns++)
                         {
                         Double_t low_ns_cut   = ((Double_t)n_low_ns)*delta_low_ns+start_low_ns;
                         if(
                         ((m2A < -10 && nsA < up_ns_cut && nsA > low_ns_cut) || (m2A > 0.16 && m2A < 0.36)) &&
                         ((m2B < -10 && nsB < up_ns_cut && nsB > low_ns_cut) || (m2B > 0.16 && m2B < 0.36))
                         )
                         {
                         for(Int_t n_m = 0; n_m < n_cuts_var; n_m++)
                         {
                         Double_t m_cut        = ((Double_t)n_m)*delta_m+start_m;
                         for(Int_t n_t = 0; n_t < n_cuts_var; n_t++)
                         {
                         Double_t t_cut        = ((Double_t)n_t)*delta_t+start_t;
                         if(
                         ((nsA < (m_cut*fabs(qpA)+t_cut) && m2A > 0.16 && m2A < 0.36) || (nsA > (m_cut*fabs(qpA)+t_cut))) &&
                         ((nsB < (m_cut*fabs(qpB)+t_cut) && m2B > 0.16 && m2B < 0.36) || (nsB > (m_cut*fabs(qpB)+t_cut)))
                         )
                         {
                         Int_t bin_pt_cuts_var = n_low_ns + n_up_ns*n_cuts_var + n_t*n_cuts_var*n_cuts_var + n_m*n_cuts_var*n_cuts_var*n_cuts_var + n_p_t*n_cuts_var*n_cuts_var*n_cuts_var*n_cuts_var;
                         hInvMass_pt_cuts_var[SE_ME_loop][ept_bin][bin_pt_cuts_var]->Fill(InvAB,reweight);
                         }
                         }
                         }
                         }
                        ...
                        // These parameters are from a study based on 11.5 GeV data. It turned out they are not better/worse than the
                        // more simpler cuts
                        Int_t n_p_t    = params_best_cuts[ept_bin][0];
                        Int_t n_m      = params_best_cuts[ept_bin][1];
                        Int_t n_t      = params_best_cuts[ept_bin][2];
                        Int_t n_up_ns  = params_best_cuts[ept_bin][3];
                        Int_t n_low_ns = params_best_cuts[ept_bin][4];
                        ...
                        {
                            hInvMass_pt_cuts[SE_ME_loop][ept_bin][7] ->Fill(InvAB,reweight);
                        }
                        if(
                           (p_t < p_t_cut || (p_t >= p_t_cut && ( (m2A > 0.16 && m2A < 0.36) || (m2B > 0.16 && m2B < 0.36) ) )) &&
                           ((nsA < (m_cut*fabs(qpA)+t_cut) && m2A > 0.16 && m2A < 0.36) || (nsA > (m_cut*fabs(qpA)+t_cut))) &&
                        ...
                        {
                            hInvMass_pt_cuts[SE_ME_loop][ept_bin][8] ->Fill(InvAB,reweight);
                        }
                        if(
                           (p_t < p_t_cut || (p_t >= p_t_cut && ( (m2A > 0.16 && m2A < 0.36) || (m2B > 0.16 && m2B < 0.36) ) )) &&
                           ((m2A < -10 && nsA < up_ns_cut && nsA > low_ns_cut) || (m2A > 0.16 && m2A < 0.36)) &&
                        ...
                        {
                            hInvMass_pt_cuts[SE_ME_loop][ept_bin][9] ->Fill(InvAB,reweight);
                        }

                        hInvMass_pt_cuts[SE_ME_loop][ept_bin][0] ->Fill(InvAB,reweight);

                        if( // These are the original cuts. Only for 7.7,(V1) 11.5 (newPID) ntuples the cuts were changed
                           ((fabs(qpA) <= 0.65 && m2A < -10) ||
                            (m2A > 0 && ((fabs(qpA) < 1.5 && m2A > 0.16 && m2A < 0.36) || (fabs(qpA) >= 1.5 && m2A > 0.125 && m2A < 0.36)) )
                           )
                           &&
                           ((fabs(qpB) <= 0.65 && m2B < -10) ||
                            (m2B > 0 && ((fabs(qpB) < 1.5 && m2B > 0.16 && m2B < 0.36) || (fabs(qpB) >= 1.5 && m2B > 0.125 && m2B < 0.36)) )
                           )
                          )
                        {
                            hInvMass_pt_cuts[SE_ME_loop][ept_bin][1] ->Fill(InvAB,reweight);
                            if( p_t < 0.8 || (p_t >= 0.8 && ( (m2A > 0.16 && m2A < 0.36) || (m2B > 0.16 && m2B < 0.36) ) ) )
                            {
                                hInvMass_pt_cuts[SE_ME_loop][ept_bin][2] ->Fill(InvAB,reweight);
                                //--------------------------------------------------------------------------------
                                if(
                                ...
                                {
                                    hInvMass_pt_cuts[SE_ME_loop][ept_bin][3] ->Fill(InvAB,reweight);
                                }
                            }
                        }

                        if( // These are the previous best cuts
                          ...
                          )
                        {
                            ...
                            {
                                hInvMass_pt_cuts[SE_ME_loop][ept_bin][5] ->Fill(InvAB,reweight); // best cut
                            }
                        }
                        ...
                        {
                            hInvMass_pt_cuts[SE_ME_loop][ept_bin][4] ->Fill(InvAB,reweight);
                        }
                        ...
                        {
                            hInvMass_pt[SE_ME_loop][ept_bin] ->Fill(InvAB,reweight);

                            hInvMass_pt_cuts[SE_ME_loop][ept_bin][6] ->Fill(InvAB,reweight); // best cut
                            hInvMass_mult_pt_seme[4+erefMult_bin][ept_bin][SE_ME_loop] ->Fill(InvAB,reweight);

                            Int_t mult_bin = 0; // 0-80%
                            hInvMass_mult_pt_seme[mult_bin][ept_bin][SE_ME_loop] ->Fill(InvAB,reweight);
                            ...
                            for(Int_t m_ep = 0; m_ep < nep_methods; m_ep++)
                            {
                                ...
                                {
                                    hInvMass_mult_pt_phi_ep_seme[4+erefMult_bin][ept_bin][phi_bin_all[m_ep]][m_ep][SE_ME_loop] ->Fill(InvAB,reweight/Event_Plane_resolution[erefMult_bin][m_ep]);

                                    Int_t mult_bin = 0; // 0-80%
                                    hInvMass_mult_pt_phi_ep_seme[mult_bin][ept_bin][phi_bin_all[m_ep]][m_ep][SE_ME_loop] ->Fill(InvAB,reweight/Event_Plane_resolution[erefMult_bin][m_ep]);
                                    if(erefMult_bin == 7 || erefMult_bin == 8) // 0-10
                                    {
                                        mult_bin = 1;
                                        hInvMass_mult_pt_phi_ep_seme[mult_bin][ept_bin][phi_bin_all[m_ep]][m_ep][SE_ME_loop] ->Fill(InvAB,reweight/Event_Plane_resolution[erefMult_bin][m_ep]);
...
void StStrangenessAna::finalize()
{
    ...
    /*
    Outputfile      ->cd();
    Outputfile      ->mkdir("hInvMass_pt_cuts_var");
    Outputfile      ->cd("hInvMass_pt_cuts_var");
    for(Int_t SE_ME_loop = 0; SE_ME_loop < 2; SE_ME_loop++) // 0 = same event, 1 = mixed event
    {
        for(Int_t pt_bin = 0; pt_bin < npt_bins; pt_bin++)
        {
                ...
                for(Int_t n_m = 0; n_m < n_cuts_var; n_m++)
                {
                    for(Int_t n_t = 0; n_t < n_cuts_var; n_t++)
                    {
                        for(Int_t n_up_ns = 0; n_up_ns < n_cuts_var; n_up_ns++)
                        {
                            ...
                            {
                                Int_t bin_pt_cuts_var = n_low_ns + n_up_ns*n_cuts_var + n_t*n_cuts_var*n_cuts_var + n_m*n_cuts_var*n_cuts_var*n_cuts_var + n_p_t*n_cuts_var*n_cuts_var*n_cuts_var*n_cuts_var;
                                hInvMass_pt_cuts_var[SE_ME_loop][pt_bin][bin_pt_cuts_var] ->Write();
                            }
                        }
                    }
                }
