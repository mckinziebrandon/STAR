...
do
    ...
    echo -n '0,0,90000000,"'>>run_dev2$FILE.csh
    ...
    qsub  -hard -l projectio=1,gscratchio=1,scratchfree=500,h_cpu=2:00:00,h_vmem=0.6G -o log/job_dev2$FILE.log -e log/job_dev2$FILE.err ./run_dev2$FILE.csh
